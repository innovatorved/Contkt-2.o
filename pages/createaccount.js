          ...
          <div className="xl:w-10/12 w-full px-4">
            <div className="xl:px-24">
              ...
              <form onSubmit={CreateNewUser}>
                ...
                <div className="mt-16 flex justify-end border-b border-gray-200 pb-16 mb-4">
                  <div>
                    <div className="md:w-64 md:mt-0 mt-4">
                      <button
                        ...
                        disabled={
                          (pass.password === pass.confirmPassword
                            ? false
                            : true) | (state === "yes" ? true : false)
                        }
                        className={`${
                          pass.password === pass.confirmPassword
                            ? "hover:bg-[#F97316]"
                            : ""
                        } group relative w-64 lg:w-96 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500`}
                      >
                        <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                          {process === false ? (
                            ...
                            <svg
                              className="animate-spin absolute -ml-1 mr-3 h-5 w-5 text-white"
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 24 24"
                            >
